defmodule Fitcrm.Csv.Csvparse do
  ...
  ## Examples
      ...
      :ok
  """
  def read(path), do: Fitcrm.Csv.FileReader.rows(path)
  ...
  ## Examples
      ...
      :ok
  """
  def parse(str), do: Fitcrm.Csv.StringReader.read(str)
  ...
  """
  def write(enum), do: Fitcrm.Csv.Writer.write(enum)
  ...
  ## Examples
      ...
      "a,b,c\\n"
  """
  def write_row(list), do: Fitcrm.Csv.Writer.write_row(list)
end
